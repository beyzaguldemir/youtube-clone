...
const Header = () => {
  ...
  const handleSubmit=(e)=>{
    //Form gönderilince calısacak fonksiyondur
  ...
  return (
    <header className='flex justify-between items-center p-4'>
      <Link className='flex items-center gap-2' to="/">
        <img className='w-[50px]' src="/public/youtube_logo.png" alt="logo" />
      ...
      <form onSubmit={handleSubmit} className='group flex border border-gray-400 rounded-[20px] overflow-hidden'>
        ...
        <button className='px-4 text-2xl bg-zinc-800'><CiSearch /></button>
      </form>
